...
public class KNN {
	...
	static public void knn(String trainingFile, String testFile, int K, int metricType){
	...
	public static TrainRecord[] findKNearestNeighbors(TrainRecord[] trainingSet, TestRecord testRecord,int K, Metric metric){
