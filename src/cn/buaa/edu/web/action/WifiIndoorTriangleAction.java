...
public class WifiIndoorTriangleAction extends ActionSupport implements ServletRequestAware,ServletResponseAware {
	private Logger logger = Logger.getLogger(WifiIndoorTriangleAction.class);
	...
	public String get() throws Exception{
		...
		LocationResult locationResult = method.getLocByTriangleMethodUsingActiveMQ(device_mac);
